...
const closeButtonPopupProfile = document.querySelector('.popup__close-button-profile');
const closeButtonPopupCard = document.querySelector('.popup__close-button-card');
const closeButtonPopupView = document.querySelector('.popup__close-button-view');
