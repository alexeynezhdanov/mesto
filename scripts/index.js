...
let closeButtonPopupProfile = document.querySelector('.popup__close-button-profile');
let closeButtonPopupCard = document.querySelector('.popup__close-button-card');
let closeButtonPopupView = document.querySelector('.popup__close-button-view');
